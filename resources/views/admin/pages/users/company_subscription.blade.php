                                    ...
                                    <div class="profile-info-name">
                                        ...
                                        <div class="profile-info-detail">
                                            <h4 class="m-0">{{$user->name}}</h4>
                                             <p class="text-muted m-b-20"><b>{{trans('words.email')}}:</b> {{$user->email}} <br/><b>{{trans('words.phone')}}:</b> {{$user->phone}}
                                             <br/><b>{{trans('words.address')}}:</b> {{stripslashes($user->address)}}

                                             <br/><br/><b>{{trans('words.website')}}:</b> {{stripslashes($user->company_website)}}

                                             <br/><b>{{trans('words.company_working_day')}}:</b> {{stripslashes($user->company_working_day)}}
                                             
                                             <br/><b>{{trans('words.company_working_time')}}:</b> {{stripslashes($user->company_working_time)}}
                                            </p>
                                    ...
                                    <ul class="list-group m-b-0 user-list">
                                        ...
                                        <li class="list-group-item">
                                            <a href="#" class="user-list-item">
                                                ...
                                                <div class="user-desc">
                                                    <span class="name">{{\App\SubscriptionPlan::getSubscriptionPlanInfo($user->plan_id,'plan_job_limit')}}</span>
                                                    <span class="desc">{{trans('words.job_limit')}}</span>
                                                </div>
                                            </a>
                                        </li>
                        ...
                        <div class="row">
                          <div class="col-sm-12">
                            ...
                            <div class="card-box">
                              ...
                              <h4 class="header-title m-t-0 m-b-30">{{trans('words.transactions')}}</h4>
