              ...
              <div class="card-box">
                ...
                {!! Form::open(array('url' => 'admin/verify_purchase_app','class'=>'form-horizontal','name'=>'profile_form','id'=>'profile_form','role'=>'form','enctype' => 'multipart/form-data')) !!}
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                       <input type="text" name="buyer_name" value="{{$settings->envato_buyer_name}}" class="form-control">
                    </div>
                  </div>                   
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Buyer Purchase Code *</label>
                    <div class="col-sm-8">
                       <input type="text" name="purchase_code" value="{{$settings->envato_purchase_code}}" class="form-control" value="">
