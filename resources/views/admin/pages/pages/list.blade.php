                  ...
                  <tbody>
                   @foreach($pages_list as $i => $page)
                    <tr id="post_id_{{$page->id}}">
                      ...
                      <a href="{{ url('page/'.$page->id.'/'.$page->page_slug) }}" class="btn btn-icon waves-effect waves-light btn-info m-b-5 m-r-5" data-toggle="tooltip" title="{{trans('words.preview')}}" target="_blank"> <i class="fa fa-link"></i> </a>  
                      ...
                      @if($page->id!=1 AND $page->id!=2 AND $page->id!=3 AND $page->id!=4)
