...
<tbody>
<tr>
<td><a href="{{ url('/') }}" target="_blank"><img style="border:0;display:block;outline:none;text-decoration:none;height:auto;min-width: 20%;width: 20%;max-width: 100%;font-size: 13px;margin: 0 auto;padding: 25px;" src="{{ URL::asset('/'.getcong('app_logo')) }}" width="200" height="25" style="width:200px;height:25px"></a></td> 
</tr>
</tbody>
</table>
</td>
...
<tr>
<td dir="ltr" style="font-size:0px;padding:5px 5px 5px 5px;word-break:break-word" align="left">
<div style="font-family:Helvetica Neue, Helvetica;font-size:16px;line-height:24px;text-align:left;color:#282828">As Per Your Request Your Account With {{getcong('app_name')}} is Deleted permanently And We don't have stored any of information shared with us.</div>

<div style="font-family:Helvetica Neue, Helvetica;font-size:16px;line-height:24px;text-align:left;color:#282828"><br/>
Thanks For Your Association with {{getcong('app_name')}}
</div>
</td>
</tr>
</tbody>
...
<div style="font-family:Helvetica Neue, Helvetica;font-size:14px;font-weight:500;line-height:16px;text-align:center;color:#1e2026">© {{date('Y')}} {{getcong('app_name')}}, All Rights Reserved.</div>
</td>
</tr>
</tbody>
</table>
